...
use crate::attacks::tables::{BISHOP_ATTACKS, BISHOP_MAGICS, BISHOP_MASKS, BISHOP_SHIFTS, KING_MOVES, KNIGHT_MOVES, ROOK_ATTACKS, ROOK_MAGICS, ROOK_MASKS, ROOK_SHIFTS};
...
fn orthogonal_moves(allies: u64, enemies: u64, moves: &mut MoveList, sq: u8) {
    let attacks: u64 = orthogonal_attacks(sq as usize, allies|enemies) & !allies;
...
fn diagonal_moves(allies: u64, enemies: u64, moves: &mut MoveList, sq: u8) {
    let attacks: u64 = diagonal_attacks(sq as usize, allies | enemies) & !allies;
